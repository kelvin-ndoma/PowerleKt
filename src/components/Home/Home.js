  ...
  return (
    <div className="about-section">
      ...
      <div className="content">
        <h2>About MedTech Solutions</h2>
        <p>MedTech Solutions is a leading provider of high-quality medical equipment, dedicated to improving patient care and healthcare outcomes.</p>
        ...
        <p>Whether you are a small clinic, a hospital, or a research facility, MedTech Solutions is your trusted partner for all your medical equipment needs. We strive to make a positive impact on healthcare by delivering reliable products and superior customer service.</p>
        <p>Get in touch with us today to explore our wide range of medical equipment offerings and experience the MedTech Solutions difference.</p>
      </div>
